...
$(window).scroll(function(){
            ...
            if ($(window).scrollTop() >= 50 ) {
                ...
                $('.tp-header-5-area').addClass('fixed-header');
            }
            else {

                $('.tp-header-5-area').removeClass('fixed-header');
            }
});   
/*testimonials*/
window.addEventListener("load", function () {
    const boxes = document.querySelectorAll(".stt-wrap");

    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                entry.target.classList.add("animate");   // straighten
            } else {
                entry.target.classList.remove("animate"); // tilt back
            }
        });
    }, { threshold: 0.2 });
...
/*swipers*/
  var swiper = new Swiper(".clients-home-active", {
    loop: false,
    autoplay: false,
    slidesPerView: 4,
    spaceBetween: 30,
    ...
    var swiper = new Swiper(".digital-solutions", {
    loop: false,
    autoplay: false,
    slidesPerView: 3.5,
    spaceBetween: 30,
...
var swiper = new Swiper(".design-testimonial-active", {
    loop: false,
    autoplay: false, 
    spaceBetween: 20,
    breakpoints: {
    ...
    autoplay: false,  },
      992: { slidesPerView: 4, loop: false,
    autoplay: false,  },
      1200: { slidesPerView: 4 , loop: false,
    autoplay: false, },
      1600: { slidesPerView: 5, loop: false,
    autoplay: false, }
    }
});
var swiper = new Swiper(".design-testimonial-active-one", {
    loop: false,
    autoplay: false, 
    spaceBetween: 20,
    breakpoints: {
    ...
    autoplay: false,  },
      1200: { slidesPerView: 4 , loop: false,
    autoplay: false, },
      1600: { slidesPerView: 4, loop: false,
    autoplay: false, }
    }
});

    var swiper = new Swiper(".certified-partners", {
    loop: true,
    speed: 3000,
    autoplay: {
      delay: 3500,
...
var swiper = new Swiper(".clients-komquest", {
    loop: false,
    autoplay: false, 
    spaceBetween: 20,
    breakpoints: {
    ...
    autoplay: false,  },
      1200: { slidesPerView: 4 , loop: false,
    autoplay: false, },
	1499: { slidesPerView: 6 , loop: false,
    autoplay: false, },
      1600: { slidesPerView: 6, loop: false,
    autoplay: false, }
    }
});


var swiper = new Swiper(".testimonials-komquest-new", {
    loop: false,
    autoplay: false, 
    spaceBetween: 20,
    breakpoints: {
      ...
      768: { slidesPerView: 2, loop: false,
    autoplay: false,  },
      992: { slidesPerView: 2, loop: false,
    autoplay: false,  },
      1200: { slidesPerView: 5 , loop: false,
    autoplay: false, },
	1499: { slidesPerView: 5 , loop: false,
    autoplay: false, },
      1600: { slidesPerView: 5, loop: false,
    autoplay: false, }
    }
